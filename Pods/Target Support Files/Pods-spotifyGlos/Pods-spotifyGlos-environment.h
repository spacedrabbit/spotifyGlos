...
// sonos-objc
#define COCOAPODS_POD_AVAILABLE_sonos_objc
#define COCOAPODS_VERSION_MAJOR_sonos_objc 0
#define COCOAPODS_VERSION_MINOR_sonos_objc 1
#define COCOAPODS_VERSION_PATCH_sonos_objc 1
